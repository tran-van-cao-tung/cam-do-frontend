            ...
            <div className="full_detailContract">
              <table className="table__detailContract">
                ...
                <tr>
                  ...
                  <th colSpan="2" className="start-red" style={{ textAlign: "right" }}>{detailPawn.loan ? formatMoney(detailPawn.loan) : "0 VNĐ"}</th>
                </tr>
                <tr>
                  <th colSpan="2">Vay từ ngày</th>
                  <th colSpan="1" style={{ textAlign: "right" }}>{moment(detailPawn.contractStartDate).format('DD/MM/YYYY')}</th>
                  <th colSpan="1" style={{ textAlign: "right" }}>{moment(detailPawn.contractEndDate).format('DD/MM/YYYY')}</th>
                </tr>
              </table>
              <table className="table__detailContract">
                <tr>
                ...
                <tr>
                  ...
                  <th className="start-red" style={{ textAlign: "right" }}>{detailPawn.interestPaid ? formatMoney(detailPawn.interestPaid) : "0 VNĐ"}</th>
                </tr>
                <tr>
                  <th>Nợ lãi cũ:</th>
                  <th style={{ textAlign: "right" }}><span className="start-red">{detailPawn.interestDebt ? formatMoney(detailPawn.interestDebt) : ""}</span></th>
