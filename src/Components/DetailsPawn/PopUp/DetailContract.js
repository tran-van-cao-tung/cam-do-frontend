...
const DetailContract = ({ setshowdetailContract, showContractId }) => {
    ...
    useEffect(() => {
        axios
            .get(`http://tranvancaotung-001-site1.ftempurl.com/api/v1/contract/getAll/0`, {
    ...
    useEffect(() => {
        ...
        axios
            .get(`http://tranvancaotung-001-site1.ftempurl.com/api/v1/contract/getContractDetail/${id}`, {
                headers: { Authorization: `Bearer ${localStorage.getItem('accessToken')}` },
            })
            .then((res) => {
                                ...
                                <Grid item xs={12} md={6}>
                                    <table className="table__liquidation">
                                        ...
                                        <tr>
                                            ...
                                            <th className="start-red">
                                                {Intl.NumberFormat('vi-VN', {
                                                    style: 'currency',
                                                    currency: 'VND',
                                                }).format(detailPawn.interestPaid)}
                                            </th>
                                        </tr>
                                        <tr>
                                            <th>
                                                ...
                                                <span className="start-red">
                                                    {Intl.NumberFormat('vi-VN', {
                                                        style: 'currency',
                                                        currency: 'VND',
                                                    }).format(detailPawn.interestDebt)}
                                                </span>
                                            </th>
                                            <th>
                                                Trạng thái:{' '}
