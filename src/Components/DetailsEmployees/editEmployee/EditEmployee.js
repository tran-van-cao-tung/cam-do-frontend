                ...
                <form onSubmit={handleSubmit}>
                    <div className='employeeAdd'>
                        <div className='employee_input'>
                            ...
                            <input type="text" name='fullName' onChange={(e) => handleInput(e)} value={listEmployees.fullName} />
                        </div>
                        <div className='employee_input'>
                            <span>
                        ...
                        <PasswordInput label="Mật hẩu" name="password" value={listEmployees.password} onChange={(e) => handleInput(e)} />
                        <PasswordInput label="Nhập lại mật khẩu" name='confirmPassword' value={confirmPassword} onChange={handlePasswordChange} />
                        <div className='employee_input'>
                            <span>
                                Email<span>*</span>:
                            </span>
                            <input type="text" name='email' onChange={(e) => handleInput(e)} value={listEmployees.email} />
                        </div>
                        <div className='employee_input'>
                            <span>
                                Địa chỉ <span>*</span>:
                            </span>
                            <input type="text" name='address' onChange={(e) => handleInput(e)} value={listEmployees.address} />
                        </div>
                        <div className='employee_input'>
                            <span>
                                Số điện thoại <span>*</span>:
                            </span>
                            <input type="text" name='phone' onChange={(e) => handleInput(e)} value={listEmployees.phone} />
                        </div>
