...
const WareHouse = () => {
    ...
    const rows = [
        createData('Kho 1', '120 Gò Dầu, Tân Quý, Tân Phú, TP.Hồ Chí Minh', 'Còn chỗ', 'Chức năng'),
        createData('Kho 2', '500 Tân Kỳ Tân Quý, Bình Hưng Hòa, Bình Tân, TP.Hồ Chí Minh', 'Hết chỗ', 'Chức năng'),
        createData('Kho 3', '185 Tân Kỳ Tân Quý, Bình Hưng Hòa, Bình Tân, TP.Hồ Chí Minh', 'Tạm đóng', 'Chức năng'),
    ];
                                ...
                                <TableBody>
                                    {rows.map((row, index) => (
                                        ...
                                        >
                                            ...
                                            <TableCell align="center">
                                                <Link to="/warehouse/update">
                                                    <IconButton
                                                        aria-label="edit"
                                                        color="primary"
                                                        className="edit-action-btn"
                                                    >
                                                        <img alt="edit-action" src={editIcon} />
                                                    </IconButton>
                                                </Link>
                                            </TableCell>
                                        </TableRow>
